...
import { Container as TypeDiExtensionsContainer } from 'typeorm-typedi-extensions';
...
export class Application {
    ...
    public static async createApplication() {
        ...
        useContainer(TypeDiExtensionsContainer);
        await dbCreateConnection();
        const server = new ExpressServer();
        await server.setup(Environment.ServerPort as number);
